...
void ClientConnectionManager::SetLuaFunctions(PE::Components::LuaEnvironment *pLuaEnv, lua_State *luaVM)
{
	...
	static const struct luaL_Reg l_functions[] = {
		{"l_clientConnectToUDPServer", l_clientConnectToUDPServer},
		{NULL, NULL} // sentinel
	};
...
int ClientConnectionManager::l_clientConnectToUDPServer(lua_State *luaVM)
{
	...
	pClientConnManager->clientConnectToUDPServer(strAddr, port);
